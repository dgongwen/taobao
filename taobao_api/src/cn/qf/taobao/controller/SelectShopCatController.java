 ...
 * 购物车
 */
@WebServlet("/selectShop.t")
public class SelectShopCatController extends BaseController{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            List<Commodity> commodities = commodityService.selectShopCatService(Long.valueOf(userId));
