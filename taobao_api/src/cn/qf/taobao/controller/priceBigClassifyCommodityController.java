 ...
 * 价格分类降序
 */
@WebServlet("/priceBig.t")
public class priceBigClassifyCommodityController extends BaseController{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            List<Commodity> commodities = commodityService.priceBigClassifyCommodityService(Long.valueOf(num), Long.valueOf(pages));
