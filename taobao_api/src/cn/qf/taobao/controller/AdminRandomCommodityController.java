...
@WebServlet("/randomCommodity.d")
public class AdminRandomCommodityController extends BaseController{
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try{
            List<AdminCommodityQO> ad =  adminCommodityService.randomCommodity();
