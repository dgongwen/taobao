 ...
 * 设置默认收货地址
 */
@WebServlet("/setDefaultAddress.t")
public class setDefaultAddressController extends BaseController{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            List<Address> addresses = userService.setDefaultAddress(Long.valueOf(userId1), Long.valueOf(addressId));
